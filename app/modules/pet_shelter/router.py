...
from app.modules.pet_shelter.services.create_pet_shelter import (
    CreatePetShelterService,
)
from sqlalchemy.orm import Session
from app.modules.pet_shelter.services.get_pet import GetPetService

from app.modules.pet_shelter.services.get_pet_shelter import (
    GetPetShelterService,
)
...
def create_pet_shelter(
    pet_shelter_form: PetShelterIn, db: Session = Depends(get_db)
):
...
def get_pets_from_pet_shelter(
    pet_shelter_id: str, db: Session = Depends(get_db)
):
